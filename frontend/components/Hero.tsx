...
const Hero = () => {
  ...
  <section className='bg-hero-image bg-current bg-cover   bg-no-repeat '>
    ...
    <div className=' flex flex-col gap-2'>
        <p className='custom-lg:text-[64px] custom-xxl:text-[94px] lg:max-w-none md:max-text-[44px] md:text-[28px] max-sm:text-[26px] sm:text-[25px]  font-montserrat font-semibold text-white mb-2'>Buy And Sell Digital Art, NFT Collection & Coin </p>
