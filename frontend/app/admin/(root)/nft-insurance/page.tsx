  ...
  return (
    ...
    <div className='flex justify-between mb-14 max-md:mb-7 items-center'>
        ...
        <div className='flex flex-col mt-4 gap-10 w-3/4'>
            ...
            <div className='flex flex-col gap-3'>
            <h1 className='text-white font-bold text-[22px] font-manrope'>Low Coverage Limit</h1>
            ...
            <div className='flex flex-col gap-3'>
            <h1 className='text-white font-bold text-[22px] font-manrope'>Upper Coverage Limit</h1>
            ...
            <div className='flex flex-col gap-3'>
            <h1 className='text-white font-bold text-[22px] font-manrope'>Lower Threshold price</h1>
            <input className='bg-transparent w-full  border-2 border-white rounded-xl font-bold p-2 text-white text-[18px] ' value={lowerThresholdPriceValue} onChange={(e)=>{setLowerThresholdPriceValue(e.target.value)}} disabled = {viewOnly} />
