        ...
        <div className='w-full flex flex-col lg:px-8 lg:py-14 md:p-10 max-md:p-4'>
          ...
          <div className='flex justify-between'>
            <div className='flex 2xl:mt-4  flex-col gap-3'>
              ...
              <Link target='_blank' href="https://testnets.opensea.io/collection/bitsi-nft-3"><Image src='/icons/opensea_icon.svg' height={40} width={40} alt='opensea icon' /></Link>
              <Link target='_blank' href="https://testnet.rarible.com/collection/0x28A3046109Db1871541Bd60cF43F44fEc803437f/items"><Image src='/icons/rarible_icon.svg' height={40} width={40} alt='opensea icon' /></Link>
              </div>
