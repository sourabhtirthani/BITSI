...
const BitsiCoin = () => {
  return (
    ...
    <section className='bg-hero-bitsi-coin bg-cover opacity-80 '>
        <div className='flex flex-col px-16 py-8 max-md:px-8 max-md:py-4 '>
    ...
    <section className='bg-success-503'>
        <h3 className='text-white font-manrope text-[32px] max-sm:text-[24px] font-semibold px-12 py-3 mt-14  max-sm:px-12 max-sm:mt-6'>Minted Coins / First Hand</h3>
        <div className='grid grid-cols-3 p-8 h-full max-lg:grid-cols-2 max-sm:grid-cols-1'>
    ...
    <h3 className='text-white font-manrope text-[32px] max-sm:text-[24px] font-semibold px-12 py-3 max-sm:px-12 max-sm:mt-6'>Second Hand</h3>
        <div className='grid grid-cols-3 p-8 h-full max-lg:grid-cols-2 max-sm:grid-cols-1'>
    {bitsiCoinCardData.map((item)=>{
        return (
            <div className='p-4' key={item.id}>
