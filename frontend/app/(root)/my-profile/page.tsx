    ...
    <>
      ...
      <section className='bg-success-503 '>
        ...
        <div className='flex p-2 gap-4 px-7 max-sm:flex-col w-full flex-wrap'>
          <button onClick={handleMyProfileClick} className='bg-success-512 hover:bg-success-509  secondary-shadow11 text-white text-[22px] font-bold px-14 rounded-xl max-sm:px-8 py-2 max-sm:py-3.5 '>My Profile</button>
          ...
          <button hidden = {!isConnected} onClick={handleCompensationClick} className='bg-success-512 hover:bg-success-509  secondary-shadow11 text-white text-[22px] font-bold px-14 rounded-xl max-sm:px-8 py-2 max-sm:py-3.5'>My Compensation</button>
          <button hidden = {!isConnected} onClick={handleCollectionClick} className={`${dataOfNftsOfUser.length === 0 ? 'hidden' : ''} bg-success-512 hover:bg-success-509  secondary-shadow11 text-white text-[22px] font-bold px-14 rounded-xl max-sm:px-8 py-2 max-sm:py-3.5`}>My Collection</button>
                  ...
                  return (
                    <React.Fragment key={index}>
                      <tr className='bg-success-512 h-12 text-center secondary-shadow11 w-full text-white font-montserrat text-[12px] max-sm:text-[8px] font-semibold'>
                        <td className='p-2 py-5 max-sm:p-1'>{item.requestDate}</td>
                        <td className='p-2 max-sm:p-1'>{item.Asset}</td>
